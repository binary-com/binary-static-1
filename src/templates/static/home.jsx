...
} from "../_common/components/separator_line.jsx"
import {
  TabContainer,
  TabContentContainer,
  TabsSubtabs,
...
const ArrowsMobile = ({ direction, parent }) => (
  <div
    className={`align-self-center ${
      parent === "market_tabs" ? "gr-1" : "gr-2"
    } gr-hide gr-show-m gr-show-p gr-no-gutter`}
  >
    <img
      ...
      <div className="gr-6 gr-12-m gr-12-p center-text-m order-2-m">
        <div className="gr-12-m gr-10-p gr-centered gr-gutter">
          <div className="gr-row">
            ...
            <strong className="align-self-center gr-centered-m">
              {header}
            </strong>
    ...
    <div className="gr-row gr-padding-30">
      ...
      <div className="gr-10 gr-12-m">
        <div className="gr-row">
          ...
          <div
            className={`center-text gr-12 gr-hide gr-show-m ${
              mobile_class || ""
            }`}
          >
            <div className="gr-10 gr-centered margin-top-10">
              <div className="gr-row">
                ...
                <strong className="align-self-center gr-centered">
                  {mobile_header}
                </strong>
    ...
    <React.Fragment>
      ...
      <div id="banner">
        <div className="container gr-padding-20">
          <h1 className="dark center-text gr-padding-20 gr-child">
            {it.L(
              "Online Trading with [_1]",
              `<strong>${it.website_name}</strong>`
            )}
          </h1>
          <p className="center-text gr-padding-10">
            {it.L("Trade 24/7, even on weekends.")}
          </p>
          ...
          <div className="gr-padding-30 gr-11-m gr-centered gr-child">
            ...
            <div
              id="social-signup"
              className="gr-8 gr-10-p gr-12-m gr-no-gutter gr-centered"
            >
              <SeparatorLineWithText
                text={it.L("or")}
                className="gr-padding-20 no-margin full-width"
              />
              <p className="center-text no-margin gr-padding-10 gr-parent">
      ...
      <div className="container gr-padding-30">
        <h2 className="center-text">
          {it.L("Diverse platforms and account types")}
        </h2>
        <TabContainer
          className="gr-padding-30 gr-parent full-width"
          theme="light"
        >
          <TabsSubtabs
            id="account_tabs"
            ...
            <TabContentContainer>
              <TabContent id="binary_options">
                <AccountsTabContent
                  ...
                  list_text_one={it.L(
                    "Practice account with replenishable 10,000 USD demo credit."
                  )}
              ...
              <TabContent id="mt5">
                <AccountsTabContent
                  ...
                  list_text_four={it.L(
                    "MT5 real-money account for forex and cryptocurrencies."
                  )}
                />
              </TabContent>
            </TabContentContainer>
        ...
        <div className="center-text gr-padding-20 gr-parent">
          <h3 className="center-text gr-padding-20 gr-parent">
            {it.L(
      ...
      <div id="market_tabs_container" className="container">
        <h2 className="center-text gr-padding-10">
          {it.L("Trade in the world's financial markets")}
        </h2>
        <TabContainer
          className="gr-padding-30 gr-parent full-width"
          theme="light"
        ...
        <h3 className="center-text gr-padding-30">
          {it.L(
          ...
          <div className="gr-row container">
            <div className="gr-12 align-self-center center-text gr-padding-10">
              <h3 className="no-margin">
                {it.L("Award-winning trading excellence")}
              </h3>
            </div>
            <div className="award-icons">
              ...
              <div className="award-icon">
                <img
                  ...
                  src={it.url_for("images/pages/home/awards/gbfr-2012.svg")}
                  alt="Global Banking and Finance Review 2012"
                />
                <span className="caption">
                  {it.L("Global Banking and Finance Review")}
                </span>
              </div>
              <div className="award-icon">
                <img
                  className="responsive"
                  src={it.url_for("images/pages/home/awards/egr-2015.svg")}
                  alt="EGR Operator Awards 2015"
                />
              ...
              <div className="award-icon">
                <img
                  className="responsive"
                  src={it.url_for("images/pages/home/awards/mena-2016.svg")}
                  alt="16th MENA Financial Forum & Expo 2016"
                />
                <span className="caption">
                  {it.L("16th MENA Financial Forum & Expo")}
                </span>
              </div>
              <div className="award-icon">
                <img
                  className="responsive"
                  src={it.url_for("images/pages/home/awards/opm-2017.svg")}
                  alt="Online Personal Wealth Awards 2017"
                />
                <span className="caption">
                  {it.L("Online Personal Wealth Awards")}
                </span>
              </div>
              <div className="award-icon">
                <img
                  className="responsive"
                  src={it.url_for("images/pages/home/awards/gbf-2018.svg")}
                  alt="Global Banking & Finance Awards 2018"
                />
                <span className="caption">
                  {it.L("Global Banking & Finance Awards")}
                </span>
              </div>
              <div className="award-icon">
                <img
                  className="responsive"
                  src={it.url_for("images/pages/home/awards/gbm-2018.svg")}
                  alt="Global Brands Magazine 2018"
                />
                <span className="caption">
                  {it.L("Global Brands Magazine")}
                </span>
              </div>
              <div className="award-icon">
                <img
                  className="responsive"
                  src={it.url_for("images/pages/home/awards/gbm-2019.svg")}
                  alt="Global Brands Magazine 2019"
                />
                <span className="caption">
                  {it.L("Global Brands Magazine")}
                </span>

...
const TimelineFirst = () => (
  <div className="gr-1 gr-2-m gr-centered">
    <img
      ...
      src={it.url_for("images/pages/regulation/timeline.svg")}
    />
  </div>
)
...
const Box = ({ first, last, header, children }) => (
  <React.Fragment>
...
const RegulatorImage = ({ padding, padding_m, href, image }) => (
  ...
  return (
    <React.Fragment>
      {items.map((item, idx) => (
        <area
          shape="rect"
          coords={`${normalize(item.x * svg_scale)},${normalize(
            item.y * svg_scale
          )},${normalize(
            (item.x + (item.width || default_width) + square_wh) * svg_scale
          )},${normalize((item.y + square_wh) * svg_scale)}`}
          href={
            item.link ||
            it.url_for(`download/regulation/${item.name.replace(" ", "")}.pdf`)
          }
          alt={item.name}
          key={idx}
          target="_blank"
  ...
  return (
    <div className="static_full">
      ...
      <Box header={it.L("Deriv Limited")} first>
        <p>
          {it.L(
            "Deriv Limited, with registered office at 13 Castle Street, St. Helier, JE2 3BT, Jersey, is the holding company for the subsidiaries listed below."
          )}
        </p>
      </Box>

      <Box header={it.L("Deriv Investments (Europe) Limited")}>
        <p data-show="-eucountry">
          {it.L(
            "In the EU, financial products are offered by Deriv Investments (Europe) Limited, W Business Centre, Level 3, Triq Dun Karm, Birkirkara, BKR 9033, Malta, licensed and regulated as a Category 3 Investment Services provider by the Malta Financial Services Authority ([_1]licence no. IS/70156[_2]).",
            `<a href=${it.url_for(
              "download/WS-Deriv-Investments-Europe-Limited.pdf"
            )} target="_blank">`,
            "</a>"
          )}
        </p>
        ...
        <p>
          {it.L(
            "European Union residents who wish to trade investment products will have their accounts opened with Deriv Investments (Europe) Limited."
          )}
        </p>
        <div className="gr-padding-30 gr-12" id="accordion">
          <h3 aria-expanded="true" aria-selected="true">
            {it.L("EU Passport Rights")}
          </h3>
          <div>
            <p>
              {it.L(
                "Deriv Investments (Europe) Limited is entitled to provide services in another EU Member State through EU passporting rights. Refer to the map below for the list of EU countries that have access to [_1] via EU passporting rights - freedom to provide cross border services.",
                it.website_name
              )}
            </p>
            <div className="center-text gr-padding-10 gr-12">
              <img
                className="responsive"
                src={it.url_for("images/pages/regulation/map.svg")}
                useMap="#planetmap"
              />
            </div>
          ...
          <h3 id="key_information_documents" href="#key_information_documents">
            {it.L("Key Information Documents")}
          </h3>
          <div>
            <p>
              {it.L(
            ...
            <div className="gr-row">
              <FillBox
                ...
                border="border-dark-gray"
                href={it.url_for(
                  `/download/key_information_document/${lang_KID}/Crypto.pdf`
                )}
                target="_blank"
              ...
              <FillBox
                ...
                border="border-dark-gray"
                href={it.url_for(
                  `/download/key_information_document/${lang_KID}/Commodities.pdf`
                )}
                target="_blank"
                text={it.L("Commodities")}
              />
              <FillBox
                id="fx_fillbox"
                padding="4"
                ...
                border="border-dark-gray"
                href={it.url_for(
                  `/download/key_information_document/${lang_KID}/Forex.pdf`
                )}
                target="_blank"
                text={it.L("Forex")}
              />
              <FillBox
                ...
                border="border-dark-gray"
                href={it.url_for(
                  `/download/key_information_document/${lang_KID}/Stocks.pdf`
                )}
                target="_blank"
                text={it.L("Stocks")}
              />
              <FillBox
                ...
                border="border-dark-gray"
                href={it.url_for(
                  `/download/key_information_document/${lang_KID}/Stock-Indices.pdf`
                )}
                target="_blank"
              ...
              <FillBox
                ...
                border="border-dark-gray"
                href={it.url_for(
                  `/download/key_information_document/${lang_KID}/Synthetic-Indices.pdf`
                )}
                target="_blank"
                text={it.L("Synthetic Indices")}
              />
            </div>
          </div>
          ...
          <div className="gr-row">
            ...
            <div className="gr-6 gr-12-m">
              <FillBox
                ...
                image="images/pages/regulation/pdf-icon.svg"
                href={it.url_for(
                  "/download/20210422_Deriv_DIEL_RTS 28_Report_2020.pdf"
                )}
                target="_blank"
      ...
      <div data-show="eucountry">
        <Box header={it.L("Deriv (Europe) Limited")}>
          <p>
            {it.L(
              "“Deriv (Europe) Limited, W Business Centre, Level 3, Triq Dun Karm, Birkirkara BKR 9033, Malta, is licensed and regulated for digital options on synthetic indices by the Malta Gaming Authority in Malta ([_1]licence no. MGA/B2C/102/2000[_2]) and by Revenue Commissioners for clients in Ireland (licence no. 1010285).",
              `<a href=${it.url_for(
                "download/regulation/MGA_licence.pdf"
          ...
          <p>
            {it.L(
              "Clients in the European Union who wish to trade gambling products will have their accounts opened with Deriv (Europe) Limited."
            )}
          </p>
          <RegulatorText />
          <RegulatorImage
            padding="4"
            padding_m="8"
            href="http://www.mga.org.mt/"
            image="images/pages/why-us/mga-logo2.svg"
          />
        </Box>
      </div>
      ...
      <Box header={it.L("Deriv (SVG) LLC")}>
        <p>
          {it.L(
            "Deriv (SVG) LLC, Hinds Buildings, Kingstown, St. Vincent and the Grenadines; company number 25299 BC 2019."
          )}
        </p>
        <p>
          {it.L(
            "Clients from the rest of the world (excluding certain countries such as the USA, Canada, and Hong Kong) will have their account opened with Deriv (SVG) LLC."
          )}
        </p>
      </Box>
      ...
      <Box header={it.L("Deriv (V) Ltd")}>
        <p>
          {it.L(
            "Deriv (V) Ltd, Govant Building, Port Vila, PO Box 1276, Vanuatu, Republic of Vanuatu. Licensed and regulated by the Vanuatu Financial Services Commission - [_1]view licence[_2].",
            `<a href=${it.url_for(
              "download/regulation/Vanuatu-license.pdf"
            )} target="_blank">`,
            "</a>"
          )}
        </p>
        <p>
          {it.L(
            "Clients from the rest of the world (excluding certain countries such as the USA, Canada, Hong Kong) will have their FX and CFD Metatrader 5 account opened with Deriv (V) Ltd. [_1] is not available in the Republic of Vanuatu.",
            it.website_name
          )}
        </p>
        <RegulatorText />
        <RegulatorImage
          ...
          image="images/pages/regulation/vanuatu-logo.png"
        />
      </Box>
      ...
      <Box header={it.L("Deriv (BVI) Ltd")}>
        <p>
          {it.L(
            "Deriv (BVI) Ltd, Kingston Chambers, P.O. Box 173, Road Town, Tortola, British Virgin Islands. Licensed and regulated by the British Virgin Islands Financial Services Commission - [_1]view licence[_2].",
            `<a href=${it.url_for(
              "download/regulation/BVI_license.pdf"
            )} target="_blank">`,
            "</a>"
          )}
        </p>
        ...
        <RegulatorText />
        <RegulatorImage
          href="http://www.bvifsc.vg/"
          image="images/pages/regulation/bvi.png"
        />
      </Box>
      ...
      <Box header={it.L("Deriv (FX) Ltd")}>
        <p>
          {it.L(
            "Deriv (FX) Ltd., Lot No. F16, First Floor, Paragon Labuan, Jalan Tun Mustapha, 87000 Federal Territory of Labuan, Malaysia. Licensed and regulated by the Labuan Financial Services Authority to carry on a money-broking business [_1](licence no. MB/18/0024)[_2].",
            `<a href=${it.url_for(
              "download/regulation/Labuan-license.pdf"
            )} target="_blank">`,
            "</a>"
          )}
        </p>
        <p>
          {it.L(
            "Clients from the rest of the world (excluding certain jurisdictions such as the USA, Canada, and the European Union) who wish to trade CFDs will have their MetaTrader 5 account opened with Deriv (FX) Ltd. [_1] is not available in Malaysia.",
            it.website_name
          )}
        </p>
        <RegulatorText />
        <RegulatorImage
          ...
          image="images/pages/regulation/labuan-logo.png"
        />
      </Box>
      ...
      <Box header={it.L("The Financial Commission")} last>
        <p>
          {it.L(
            "We are registered with the Financial Commission, an international independent organisation dedicated to resolving disputes within the financial services industry ([_1]view membership[_2]).",
            `<a href=${it.url_for(
              "download/regulation/Deriv_membership.pdf"
            )} target="_blank">`,
            "</a>"
          )}
        </p>
        <p>
          {it.L(
            "The Financial Commission offers compensation up to 20,000 EUR on a case-to-case basis, unbiased assessment of disputes, and fast and effective dispute resolution free of charge."
          )}
        </p>
        <RegulatorText />
        <RegulatorImage
          ...
          image="images/pages/regulation/financial-commission.svg"
        />
      </Box>
